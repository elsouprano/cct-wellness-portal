...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                /*
                 * Only back up uploaded user files (profile pictures, announcement attachments).
                 * We deliberately do NOT back up the entire project source — code belongs in Git.
                 */
                'include' => [
        ...
        'destination' => [
             ...
             *
             * We use a dedicated 'backup' disk (defined in config/filesystems.php)
             * that points to storage/app/backups — kept out of Git via .gitignore.
             *
             * TODO (PRODUCTION): Change this to a cloud disk (e.g. 's3', 'gcs')
             * so backups are stored OFF-SERVER. A backup on the same machine it
             * protects is not a real disaster recovery plan.
             */
            'disks' => [
                'backup',
            ],
