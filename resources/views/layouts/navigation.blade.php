    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-foreground/50 hover:text-foreground hover:bg-muted focus:outline-none focus:bg-muted focus:text-foreground transition duration-200 ease-in-out">
