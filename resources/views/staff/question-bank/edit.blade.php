                                    ...
                                    <div class="flex flex-col md:flex-row gap-3 items-start bg-muted/10 p-3 rounded-xl border border-border/50 hover:border-primary/30 transition-colors relative group">
                                        ...
                                        <div class="w-full md:w-48 shrink-0">
                                            <label class="flex items-center gap-2 h-[42px]">
                                                <input type="checkbox" x-model="item.useCustomOptions" :disabled="isLocked" class="rounded border-border text-primary focus:ring-primary shadow-sm w-4 h-4 disabled:bg-gray-100 disabled:cursor-not-allowed">
                                                <span class="text-sm text-foreground/80">Custom options</span>
                                            </label>
                                            <div x-show="item.useCustomOptions" x-collapse>
                                                <textarea x-model="item.options" :name="'items['+index+'][options]'" rows="3" placeholder="Option 1&#10;Option 2&#10;Option 3" class="block w-full rounded-xl border-border shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm disabled:bg-gray-100 disabled:cursor-not-allowed mt-2" :readonly="isLocked"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="w-full md:w-48 shrink-0" x-show="subcategories.length > 0">
                                            ...
                                            <select x-model="item.question_subcategory_id" :name="'items['+index+'][question_subcategory_id]'" class="block w-full h-[42px] rounded-xl border-border shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50" :disabled="isLocked">
