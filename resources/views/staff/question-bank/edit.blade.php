                            ...
                            <div class="space-y-4">
                                <template x-for="(item, index) in items" :key="item.uid">
                                    <div class="bg-card/40 p-5 rounded-2xl border border-border shadow-sm hover:border-primary/40 hover:shadow-md transition-all relative group">
                                        ...
                                        <!-- Delete Button -->
                                        <button type="button" @click="removeItem(index)" x-show="!isLocked" class="absolute top-4 right-4 text-foreground/30 hover:text-error hover:bg-error/10 p-1.5 rounded-lg transition-colors opacity-0 group-hover:opacity-100" title="Remove question">
